...
export default function GlitchBody() {
  return (
    ...
    <div className='glitch__text-container'>
       ...
       <h2 className='glitch-body__header' data-text='RESTORATION TO OUR BODY'>RESTORATION TO OUR BODY</h2>
       <h2 className='glitch-body__header' data-text='SHOP EXPERTS'>SHOP EXPERTS</h2>
       <p className='glitch__paragraph'>From dent repairs to full-body painting and innovative options like peelable and smart paint, we offer comprehensive body care solutions. Our technicians specialize in chassis collision repairs, electric repairs, and all aspects of body maintenance. At our Body Shop, we are committed to restoring your vehicle’s structural integrity and aesthetics.</p>
    </div>

...
export default function LogoSlideshow() {
    ...
    const carLogos = [
        ...
        '/assets/images/chevy-logo.png',
        '/assets/images/chrysler-logo.png',
        '/assets/images/dodge-logo.png',
        '/assets/images/ferrari-logo.png',
        '/assets/images/fiat-logo.png',
        '/assets/images/ford-logo.png',
        '/assets/images/GMC-logo.png',
        ...
        '/assets/images/tesla-logo.png',
        '/assets/images/toyota-logo.png',
        '/assets/images/volkswagon-logo.png',
        '/assets/images/volvo-logo.png',
    ]
